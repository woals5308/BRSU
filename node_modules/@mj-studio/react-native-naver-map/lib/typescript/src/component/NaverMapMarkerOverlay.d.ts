...
export interface NaverMapMarkerOverlayProps extends BaseOverlayProps, Coord, PropsWithChildren<{}> {
    /**
     * 마커의 너비입니다.
     *
...
export declare const NaverMapMarkerOverlay: ({ latitude, longitude, zIndex, globalZIndex, isHidden, minZoom, maxZoom, isMinZoomInclusive, isMaxZoomInclusive, width, height, alpha, anchor, angle, isFlatEnabled, isForceShowIcon, isHideCollidedCaptions, isHideCollidedMarkers, isHideCollidedSymbols, isIconPerspectiveEnabled, tintColor, image, onTap, caption, subCaption, children, }: NaverMapMarkerOverlayProps) => React.JSX.Element;
//# sourceMappingURL=NaverMapMarkerOverlay.d.ts.map
...
export interface NaverMapViewRef {
     ...
     */
    animateCameraTo: (params: Coord & CameraMoveBaseParams & {
        zoom?: number;
    }) => void;
    /**
     * 카메라를 특정 위치만큼 델타값으로 애니메이션과 함께 이동시킵니다.
     */
    animateCameraBy: (params: {
        x: number;
        y: number;
    } & CameraMoveBaseParams) => void;
    /**
     ...
     */
    animateCameraWithTwoCoords: (params: {
        coord1: Coord;
        coord2: Coord;
    } & CameraMoveBaseParams) => void;
    /**
...
export declare const NaverMapView: React.ForwardRefExoticComponent<NaverMapViewProps & React.RefAttributes<NaverMapViewRef>>;
//# sourceMappingURL=NaverMapView.d.ts.map
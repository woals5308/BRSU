...
export declare const NaverMapPolygonOverlay: ({ zIndex, globalZIndex, isHidden, minZoom, maxZoom, isMinZoomInclusive, isMaxZoomInclusive, coords, holes, color, outlineWidth, outlineColor, onTap, }: NaverMapPolygonOverlayProps) => React.JSX.Element;
//# sourceMappingURL=NaverMapPolygonOverlay.d.ts.map
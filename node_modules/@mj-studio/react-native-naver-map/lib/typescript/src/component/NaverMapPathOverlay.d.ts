...
export declare const NaverMapPathOverlay: ({ zIndex, globalZIndex, isHidden, minZoom, maxZoom, isMinZoomInclusive, isMaxZoomInclusive, coords, width, color, isHideCollidedCaptions, isHideCollidedMarkers, isHideCollidedSymbols, outlineColor, outlineWidth, passedColor, passedOutlineColor, patternImage, patternInterval, progress, onTap, }: NaverMapPathOverlayProps) => React.JSX.Element | null;
//# sourceMappingURL=NaverMapPathOverlay.d.ts.map
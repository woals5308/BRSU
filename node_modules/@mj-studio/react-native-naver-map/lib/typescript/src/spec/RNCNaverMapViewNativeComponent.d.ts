...
import type { DirectEventHandler, Int32, WithDefault, Double } from 'react-native/Libraries/Types/CodegenTypes';
...
export declare const Commands: NaverMapNativeCommands;
